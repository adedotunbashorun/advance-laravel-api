...
use Modules\Users\Observers\CustomerObserver;
...
class UsersServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        User::observe(new CustomerObserver());

        Customer::observe(new SlugObserver());
        Customer::observe(new FileObserver());
    }
    ...
    public function register()
    {
        ...
        $this->app->bind(
            "Modules\Users\Repositories\CustomerInterface",
			"Modules\Users\Repositories\CustomerRepository"
        );

        $this->app->bind(
            "Modules\Users\Repositories\AuthInterface",
			"Modules\Users\Repositories\UserRepository"
		);
    }
